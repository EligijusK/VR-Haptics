...
public class CalibrationManager : MonoBehaviour
{
    ...
    private ConnectedDevices connectedDevices = new ConnectedDevices(new System.Collections.Generic.List<DeviceStatusData>(), false);
    ...
    private void OnEnable()
    {
        ...
        {
            Debug.LogWarning("CalibrationAreaManager: you have to assign tracking calibration component");
        }
    ...
    private void Awake()
    {
        ...
        {
            Debug.LogError("There is no WeArtController in the scene.");
        }
        else
        {
            if (weArtController._startCalibrationAutomatically == true)
            {
                Debug.LogError("If you are using the CalibrationManager prefab, make sure to disable StartCalibrationAutomatically from WeArtController.");
            }
            ...
            {
                Debug.LogError("There is no WeArtTrackingCalibration on the WeArtController.");
            }
            else
            {
        ...
        {
            Debug.LogError("There is no WEARTRightHand in the scene.");
        }

        if (weArtControllerLeftHand == null)
        {
            Debug.LogError("There is no WEARTLeftHand in the scene.");
        }
    }
