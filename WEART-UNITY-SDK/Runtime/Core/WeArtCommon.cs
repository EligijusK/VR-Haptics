...
namespace WeArt.Core
{
    ...
    public class ConnectedDevices : EventArgs
    {
        ...
        public List<DeviceStatusData> Devices { get; private set; }

        public ConnectedDevices(List<DeviceStatusData> devices, bool middlewareRunning)
        {
            Devices = devices;
    ...
    public static class WeArtConstants
    {
        ...
        public const string WEART_SDK_VERSION = "1.3.0";
        ...
        public const float textureVelocitySensitivity = 0.5f;
