...
namespace WeArt.Components
{
    ...
    public class WeArtController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            Debug.Log($"AAR Version: {_bluetoothManager.GetPluginVersion()}\n\n");
#endif
        }
        ...
        /// <summary>
        /// Methods that will be invoked when ble scanner sends the event that TD device is not available for connection any more.
        /// </summary>
        /// <param name="device">Device sent the event</param>
