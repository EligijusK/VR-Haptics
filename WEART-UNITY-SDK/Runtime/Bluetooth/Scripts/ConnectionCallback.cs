...
namespace WeArt.Bluetooth
{
    ...
    public class ConnectionCallback : AndroidJavaProxy
    {
        ...
        {
            Debug.Log($"PLUGIN CALLED OnConnected EVENT FOR DEVICE: {deviceMacAddress}");
        ...
        {
            Debug.Log($"PLUGIN CALLED OnDeviceReady EVENT FOR DEVICE: {deviceMacAddress}");
        ...
        {
            Debug.Log($"PLUGIN CALLED OnDisconnected EVENT FOR DEVICE: {deviceMacAddress}");
